        ...
        <div className="row  mt-3 mb-5">
          <div className="col-md-12 mb-3">
            ...
            >
              ...
              {state.a2_status === "Approved"
                ? "แบบฟอร์ม A2 ถูกอนุมัติเรียบร้อยแล้ว กรุณารอการแจ้งเตือนทาง email พร้อมติดต่อเจ้าหน้าที่เพื่อดำเนินการในขั้นตอนต่อไป"
                : state.a2_status === "Declined"
                ? "แบบฟอร์ม A2 ถูกปฏิเสธ กรุณาติดต่อเจ้าหน้าที่ หรือแก้ไขใหม่อีกครั้ง"
                : state.a2_status === "Pending"
                ? "ได้รับแบบฟอร์ม A2 ของคุณแล้ว กรุณารอการแจ้งเตือนทาง email ในภายหลัง"
                : state.a1_status === "Approved"
                ...
                : state.a1_status === "Pending"
                ? "ได้รับแบบฟอร์ม A1 ของคุณแล้ว กรุณารอการแจ้งเตือนทาง email ในภายหลัง"
